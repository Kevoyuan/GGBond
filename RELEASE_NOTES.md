...
- **Quota API**: Fetch quota using a temporary lightweight Config when CoreService.config is not available, instead of returning null. This improves quota display availability without triggering full CoreService initialization.
