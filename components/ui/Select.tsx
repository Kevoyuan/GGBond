    ...
    <div className={cn("space-y-2", className)}>
      ...
      <div className="relative" ref={menuRef}>
        <button
          ...
          className={cn(
            "w-full flex items-center justify-between px-4 py-2.5 text-sm rounded-lg border bg-background hover:border-primary/50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20",
