                        ...
                        <div className="space-y-2">
                            ...
                            <label className="block space-y-1">
                                ...
                                <textarea
                                    ...
                                    className="min-h-20 w-full rounded-md border border-border/70 bg-background px-2.5 py-2 text-sm text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] cursor-text"
                                />
                            </label>
                        </div>
                    )}
                ...
                <div className="flex items-center justify-end gap-2 border-t border-border/70 bg-muted/10 px-3 py-2.5">
                    {type === 'exit_plan_mode' && details.planPath && (
                        <button
                            ...
                            className="rounded-md px-2.5 py-1.5 text-sm font-medium text-muted-foreground border border-border hover:bg-muted hover:text-foreground transition-colors cursor-pointer mr-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
                        >
                            Open in Editor
                        </button>
                    )}
                    <button
                        ...
                        className="rounded-md px-2.5 py-1.5 text-sm font-medium text-muted-foreground hover:bg-muted hover:text-foreground transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
                    >
                    ...
                    {showAllowSession && (
                        <button
                            ...
                            className="rounded-md px-2.5 py-1.5 text-sm font-medium text-muted-foreground border border-border hover:bg-muted hover:text-foreground transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
                        >
                            Allow Session
                        </button>
                    )}
                    <button
                        ...
                        className={cn(
                            'inline-flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-sm font-semibold text-white transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]',
                            button
                        )}
                    >
