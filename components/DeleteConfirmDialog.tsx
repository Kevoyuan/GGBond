            ...
            <div className="relative w-full max-w-sm bg-background border border-border rounded-xl shadow-2xl overflow-hidden p-6 flex flex-col gap-4">
                ...
                <div className="flex items-center justify-end gap-3 mt-2">
                    ...
                    <button
                        ...
                        disabled={isDeleting}
                        className={cn(
                            "px-4 py-2 flex items-center justify-center rounded-lg text-sm font-medium text-white shadow-sm transition-colors duration-200 hover:bg-destructive/90 disabled:opacity-60",
