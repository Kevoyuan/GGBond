                    ...
                    {questions.map((q, i) => (
                        <div key={i} className="space-y-3">
                            ...
                            {(q.type === 'text' || !q.type) && (
                                <input
                                    type="text"
                                    className="w-full bg-muted/30 border border-border/50 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 transition-colors"
