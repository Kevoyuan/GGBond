...
import * as route_6 from '../legacy-api/analytics/tool-stats/route';
import * as route_7 from '../legacy-api/ask/route';
import * as route_8 from '../legacy-api/auth/route';
import * as route_9 from '../legacy-api/browser/status/route';
import * as route_10 from '../legacy-api/browser/traces/route';
import * as route_11 from '../legacy-api/chat/control/route';
import * as route_12 from '../legacy-api/chat/headless/route';
import * as route_13 from '../legacy-api/chat/route';
import * as route_14 from '../legacy-api/chat/snapshots/route';
import * as route_15 from '../legacy-api/chat/status/route';
import * as route_16 from '../legacy-api/commands/route';
import * as route_17 from '../legacy-api/config/custom-commands/route';
import * as route_18 from '../legacy-api/config/geminiignore/route';
import * as route_19 from '../legacy-api/config/route';
import * as route_20 from '../legacy-api/config/trusted-folders/route';
import * as route_21 from '../legacy-api/confirm/route';
import * as route_22 from '../legacy-api/custom-tools/route';
import * as route_23 from '../legacy-api/debug/storage/route';
import * as route_24 from '../legacy-api/directories/route';
import * as route_25 from '../legacy-api/extensions/route';
import * as route_26 from '../legacy-api/files/content/route';
import * as route_27 from '../legacy-api/files/route';
import * as route_28 from '../legacy-api/git/branch/route';
import * as route_29 from '../legacy-api/governance/steering/route';
import * as route_30 from '../legacy-api/governance/summary/route';
import * as route_31 from '../legacy-api/hooks/route';
import * as route_32 from '../legacy-api/mcp/gallery/route';
import * as route_33 from '../legacy-api/mcp/route';
import * as route_34 from '../legacy-api/memory/route';
import * as route_35 from '../legacy-api/models/route';
import * as route_36 from '../legacy-api/open/route';
import * as route_37 from '../legacy-api/presets/route';
import * as route_38 from '../legacy-api/queue/process/route';
import * as route_39 from '../legacy-api/queue/route';
import * as route_40 from '../legacy-api/queue/status/route';
import * as route_41 from '../legacy-api/quota/route';
import * as route_42 from '../legacy-api/resolve-model/route';
import * as route_43 from '../legacy-api/sessions/[id]/archive/route';
import * as route_44 from '../legacy-api/sessions/[id]/branch/route';
import * as route_45 from '../legacy-api/sessions/[id]/route';
import * as route_46 from '../legacy-api/sessions/core/route';
import * as route_47 from '../legacy-api/sessions/latest-stats/route';
import * as route_48 from '../legacy-api/sessions/route';
import * as route_49 from '../legacy-api/settings/route';
import * as route_50 from '../legacy-api/skills/route';
import * as route_51 from '../legacy-api/stats/route';
import * as route_52 from '../legacy-api/telemetry/route';
import * as route_53 from '../legacy-api/tool-output/stream/route';
import * as route_54 from '../legacy-api/tools/route';
